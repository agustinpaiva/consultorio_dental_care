...
export default function Sidebar({ userEmail, logoutAction }: SidebarProps) {
  const pathname = usePathname()
  const initial = userEmail.charAt(0).toUpperCase()

  return (
    <aside className="flex h-screen w-64 flex-col bg-slate-900 flex-shrink-0">
      {/* Logo / Brand */}
      <div className="flex items-center gap-3 border-b border-slate-700 px-6 py-5">
        ...
        <div>
          <p className="text-sm font-bold text-white">DentaApp</p>
